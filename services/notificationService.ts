...
class NotificationService {
    ...
    async sendNotification(eventType: NotificationEvent, userId: string, data: any): Promise<void> {
        console.log(`Sending notification: ${eventType} for user: ${userId}`);
    ...
    async sendAdminNotification(eventType: NotificationEvent, data: any): Promise<void> {
        console.log(`Sending admin notification: ${eventType}`);
        ...
        const adminEmail = settings.email_from_address; // You might want to add a separate admin_email field
