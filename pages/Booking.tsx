                ...
                <>
                  <div className="space-y-4">
                    <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">
                      Select Time Range for {formatDate(formData.date)}
                    </label>
          ...
          {step === 3 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8">
                Thanks {formData.name}, we've received your booking request for {formData.type} on {formatDate(formData.date)} at {formData.time}. Check your email for a confirmation.
              </p>
