        ...
        <div className="hidden print:block p-6 border-b border-gray-200 mb-4">
             <div className="flex justify-between items-start">
                 ...
                 <div className="text-right">
                    ...
                    <p className="text-sm text-gray-500">123 Creative Studio Blvd</p>
        ...
        <div className="p-8 overflow-y-auto space-y-8 bg-gray-50/50 dark:bg-obsidian/50 print:bg-white print:p-6 print:overflow-visible">
            <div className="flex justify-between items-center print:border-b print:pb-6">
                ...
                <div className="text-right">
                   ...
                   <span className="px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400 uppercase tracking-wide flex items-center gap-1 print:border print:border-green-200 print:bg-transparent print:text-green-800">
            ...
            <div className="grid grid-cols-2 gap-8 p-6 bg-white dark:bg-charcoal rounded-xl border border-gray-200 dark:border-white/5 print:border-0 print:p-0 print:gap-4">
                <div className="print:hidden">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">123 Creative Studio Blvd</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Los Angeles, CA 90012</p>
                </div>
                <div>
                    <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Bill To</h4>
                    <p className="font-bold text-gray-900 dark:text-white mb-1">Client ID: {order.id.split('-')[0]}...</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Digital Order</p>
                </div>
            </div>
