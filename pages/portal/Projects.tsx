    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
                ...
                <div className="p-4 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-obsidian/50 flex justify-between items-center">
                    {project.status === 'uploaded' && (
                        <a
                            href={`/portal/downloads?project=${project.id}`}
                            className="flex items-center gap-2 px-6 py-2.5 bg-electric hover:bg-electric/90 text-white rounded-lg font-bold transition-colors shadow-lg shadow-electric/20"
                        >
                    ...
                    <button onClick={onClose} className="px-6 py-2.5 bg-white dark:bg-white/10 border border-gray-200 dark:border-white/10 rounded-lg font-bold text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-white/20 transition-colors shadow-sm ml-auto">
                        Close Details
                    </button>
                </div>
            </motion.div>
            ...
            <div className="flex gap-2 pb-2 overflow-x-auto no-scrollbar">
                {['All Projects', 'Active', 'Completed', 'Upcoming'].map((tab) => (
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-full text-sm font-bold whitespace-nowrap transition-all ${filter === tab
