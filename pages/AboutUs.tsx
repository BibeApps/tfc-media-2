...
const AboutUs: React.FC = () => {
    ...
    return (
        <div className="min-h-screen">
            {/* Hero Section */}
            <div className="relative bg-gradient-to-br from-electric via-cyber to-neon py-24 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.h1
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="font-heading font-bold text-4xl md:text-6xl mb-6 text-white"
                    >
                        About TFC Media
                    </motion.h1>
                    <motion.p
            ...
            {/* Contact CTA Section */}
            <div className="bg-gradient-to-br from-electric via-cyber to-neon py-20">
